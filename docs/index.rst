...
VeloC will have three major impacts. It will: 

- optimize checkpoint/restart performance for applications and workflows 
- increase programmer productivity by dramatically reducing the difficulty of handling varied and complex storage architectures and the need for performance/reliability optimizations. 
- benefit a wide community.
