...
mpicc -L$1/../deploy/lib64 -I$1/../deploy/include -I$1 -o $1/build/veloc_2chkpt_mem_test $1/test/veloc_2chkpt_mem_test.c -lveloc-client
mpicc -L$1/../deploy/lib64 -I$1/../deploy/include -I$1 -o $1/build/veloc_2chkpt_file_test $1/test/veloc_2chkpt_file_test.c -lveloc-client
